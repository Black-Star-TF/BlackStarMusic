...
export const loginWithPhone = data =>
  request.post(`/login/cellphone?timestamp=${new Date().getTime()}`, data);
// 获取账号信息
...
// 收藏的专辑
export const getFavoritesAlbum = params =>
  request.get("/album/sublist", { params });
// 收藏的歌手
export const getFavoritesSinger = () => request.get("/artist/sublist");
// 收藏的视频
export const getFavoritesVideo = () => request.get("/mv/sublist");
// 收藏的专栏
export const getFavoritesColumn = params =>
  request.get("/topic/sublist", { params });
