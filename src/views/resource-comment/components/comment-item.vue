<template>
  <div class="comment-item">
    ...
    <div class="comment-content">
      <div class="comment">
        <span class="user" @click="toUserDetail(comment.user.userId)"
      ...
      <div
        ...
        v-for="reply in comment.beReplied"
        :key="reply.beRepliedCommentId"
      >
        <span class="user" @click="toUserDetail(reply.user.userId)"
      ...
      <div class="comment-operations">
        ...
        <span class="iconfont icon-dianzan">{{
          comment.likedCount | formatCount
        }}</span>
