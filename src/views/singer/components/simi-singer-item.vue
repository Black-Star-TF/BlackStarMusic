<template>
	 <div class="simi-singer-item" :style="style">
		 <!-- cover -->
		 <div class="simi-singer-cover" @click="toArtistDetail(singer.id)" :style="{'backgroundImage': `url(${coverUrl})`}"></div>
		 <!-- name -->
		 <div class="simi-singer-name">
