<template>
  <div class="album-item" :style="style">
    <div class="album-cover" :style="{'backgroundImage':`url(${coverUrl})`}" @click="toAlbumDetail(album.id)"></div>
    <div class="album-name">
      <span>{{album.name}}</span>
    </div>
    <div class="album-publish-date" @click="toAlbumDetail(album.id)">{{ album.publishTime | formatDate }}</div>
  </div>
</template>
