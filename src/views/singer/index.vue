<template>
  <div class="singer-detail-wrapper" v-if="singer">
    <div class="singer-detail-header">
      <div
        class="singer-avatar"
        :style="{ backgroundImage: `url(${singerCover})` }"
      ></div>
      <div class="singer-info">
        ...
        <div class="singer-operation">
          ...
          <span
            ...
            v-if="singer.user"
            @click="toUserDetail(singer.user.userId)"
          >
        ...
        <div class="work-info">
          <span class="item"
            >单曲数:<span class="count">{{
              singer.artist.musicSize
            }}</span></span
          >
          <span class="item"
            >专辑数:<span class="count">{{
              singer.artist.albumSize
            }}</span></span
          >
          <span class="item"
            >MV数:<span class="count">{{ singer.artist.mvSize }}</span></span
          >
        </div>
      </div>
    </div>
