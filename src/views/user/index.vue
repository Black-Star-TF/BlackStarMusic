      ...
      <div class="user-info">
        ...
        <div class="operation">
          <div class="left">
            ...
            <span
              class="gender man iconfont icon-228yonghu_xingbienan"
              v-if="user.profile.gender === 1"
            ></span>
            <span class="gender woman iconfont icon-girl" v-else></span>
          </div>
          <div class="right">
            <div class="operation-item" v-if="user.profile.artistId">
              <span class="iconfont icon-maikefeng"></span> 歌手页
            </div>
            <div class="operation-item">
              <span class="iconfont icon-duanxin"></span> 发私信
            </div>
            <div class="operation-item focus">
