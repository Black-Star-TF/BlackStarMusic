<template>
  <div class="login-use-qr">
    <h1 class="title">扫码登录</h1>
    <div class="qr-container">
      <img class="qr" :src="qrUrl">
      <div class="mask" v-if="!qrValid">
        <div class="tip">二维码已失效</div>
        <div class="btn" @click="refreshQR">点击刷新</div>
      </div>
    </div>
    
    <div class="tip">使用<a href="https://music.163.com/#/download" target="_blank">网易云音乐APP</a>扫码登录</div>
    <div class="more" @click="changeLoginType">选择其他登录方式<span class="iconfont icon-dayu"></span></div>
  </div>
</template>
